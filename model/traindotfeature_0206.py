...
def main(data_root, batch_size, epochs, hiddim, load, device, negativefold,name,esmfolder, modelname,learningrate):
    ...
    model_file = f'{data_root}/dotf_esm2_{epochs}_{modelname}_{batch_size}.th'
    out_file = f'{data_root}/predictions_{epochs}_{modelname}{batch_size}dotproductsim_esm2.pkl'
            ...
            for epoch in range(epochs):
                ...
                with ck.progressbar(length=train_steps, show_pos=True) as bar:
                    for batch_features, batch_labels in train_loader:
                        ...
                        # if pt %2000==0:
                        #     print('ouput={}\nbatch_labels={}'.format(output,batch_labels))
