...
def main(data_root, batch_size, epochs, hiddim, load, device, negativefold,name,esmfolder, modelname,learningrate,metric):
    ...
    if modelname=='onef':
        if metric =='dot':
            ...
            net = Euclideanmodel(in_dim=1280,hidden_dim=hiddim,out_dim=1280)
        elif metric =='manha':
            net = Manhattanmodel(in_dim=1280,hidden_dim=hiddim,out_dim=1280)
        # elif metric =='cheby':
        #     net = Chebychevmodel(in_dim=1280,hidden_dim=hiddim,out_dim=1280)
        ...
        if metric =='dot':
            ...
            net = twoEuclideanmodel(in_dim=1280,hidden_dim=hiddim,out_dim=1280)
        elif metric =='manha':
            net = twoManhattanmodel(in_dim=1280,hidden_dim=hiddim,out_dim=1280)
        # elif metric =='cheby':
        #     net = twoChebychevmodel(in_dim=1280,hidden_dim=hiddim,out_dim=1280)
